...
describe Display do
    ...
    context "welcome message " do
        it "displays a welcome message to users" do
            display = Display.new(input, console)

            display.welcome_message

            expect(console.string).to eq("Welcome to Tic Tac Toe\n\n")
        end
    end
    ...
    context "displays game board" do
        it "displays a blank board to users" do
            ...
            expect(console.string).to eq(expected_grid)
        end
    end
    ...
    context "user prompt " do
        it "displays a prompt for user to choose a place to mark on board" do
            ...
            expect(console.string).to eq("Please choose a number between 1 - 9: ")
        end
    end
    ...
    context "error handling" do
        it "displays an error message when user enters incorrect index" do
            ...
            expect(console.string).to eq("Input error. Try again.\n")
        end
    end
    ...
    context "when X wins the game" do
        it "displays a win message" do
            ...
            expect(console.string).to eq("X wins!")
        end
    end
    ...
    context "when O wins the game" do
        it "displays a win message" do
            ...
            expect(console.string).to eq("O wins!")
        end
    end
